                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('user.profile.update')); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="first_name" placeholder="Enter name" value="<?php echo e(Auth::user()->first_name); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="last_name">Prezime</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter name" value="<?php echo e(Auth::user()->last_name); ?>">
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('layouts.public.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-application\resources\views/user/profile/index.blade.php ENDPATH**/ ?>