        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">Uredi Stan</div>
                    </div>
                </div>

                <div class="card-body">
                    <form class="row" action="<?php echo e(route('renter.apartment.update', $apartment->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="city_id" aria-label="Default select example">
                                    ...
                                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($city->id); ?>" <?php if($apartment->city_id == ($city->id)): ?> selected <?php endif; ?> >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title" value="<?php echo e($apartment->title); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="address" class="form-control" name="address" value="<?php echo e($apartment->address); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="contact" value="<?php echo e($apartment->contact); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" min="10" name="price" value="<?php echo e($apartment->price); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" min="5" max="300" name="square_meter" value="<?php echo e($apartment->square_meter); ?>">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <textarea class="form-control" rows="3" id="description" name="description"><?php echo e($apartment->description); ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" min="0" max="30" name="floor" value="<?php echo e($apartment->floor); ?>">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-application\resources\views/renter/apartments/edit.blade.php ENDPATH**/ ?>